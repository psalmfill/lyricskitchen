    ...
    <div class="row align-items-center">
        <div class="col-md-9 col-md-offset-1">
            ...
            {{csrf_field()}}
                ...
                <textarea name="lyrics" id="" cols="30" rows="10" class="form-control summernote"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  data-role="tagsinput" placeholder="add tags" class="form-control lg-large" /> 
                    </div>
                </div>
