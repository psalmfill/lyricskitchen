...
<div class="white-box">
    <div class="row">
        ...
        <form action="{{route('admin.artist.update',$artist->id)}}" class="form-horizontal " method="post" enctype="multipart/form-data">
            {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="year" class="form-control" value="{{$artist->year}}"/>
                </div>
            
                <div class="form-group">
                    <label for="bio">Biography</label>
                    <textarea name="bio" id="" cols="30" rows="10" class="form-control summernote">
                    {{$artist->biography}}
                    </textarea>
                </div>
                <div class="form-group">
                    <label for="image">Avatar</label>
                    <input type="file" id="input-file-now" name="image" class="dropify" value="{{$artist->avatar}}" /> 
                </div>
